package com.pifss.myway.findPlace;
...
public class PlaceProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.pifss.myway.findPlace.PlaceProvider";
    ...
    String mKey = "key=AIzaSyDNh56VEfVMlmWuWOIbK3Oc94ojtA9nSr4";
    ...
    private String getPlaceDetailsUrl(String ref){
		...
		Log.d("mash", "GET PLACE *DETAIL* URL: " + url);
    ...
    private String getPlacesUrl(String qry){
        ...
        // Building the parameters to the web service
        String parameters = qry+"&"+types+"&"+sensor+"&"+"location=29.3093926,46.3705077&radius=500&"+mKey;
