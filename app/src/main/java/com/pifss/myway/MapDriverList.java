...
public class MapDriverList extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Toast.makeText(context,"lat = " + lat + "lon = " + lng, Toast.LENGTH_LONG).show();

        System.out.print("lat = " + lat + "lon = " + lng);
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLng(driverDest));
          ...
          CameraUpdate cameraPosition = CameraUpdateFactory.newLatLngZoom(driverDest, 12);
